...
class BinanceCurveDrawer:
    def __init__(self, strategy, instrument, product, interval, symbol, single_df_name, rolling_window, upper_band, lower_band):
    ...
    def draw_curves(self):
        ...
        print(f"{self.exchange}丨{self.strategy}丨{self.instrument}丨丨{self.product}丨{self.interval}丨{self.symbol}丨"
